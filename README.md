...
- Uses English text by default. Language is selected manually through `Settings -> Language...` and saved to `weather13.conf`; no locale.library auto-detection is used.
...
- Provides classic OS1.3 Intuition menus: `Project -> Info`, `Project -> Quit`, `Settings -> Location...`, `Settings -> Update Interval...`, and `Settings -> Language...`.
...
- Available UI languages are English, German, and Polish; default is English.
